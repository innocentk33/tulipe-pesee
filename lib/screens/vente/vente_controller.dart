...
class VenteController extends GetxController {
  ...
  Future<ApiResponse> submitPesee() async {
    ...
    var response = await tracabiliteRepository.updateCommandeQuantity(
        _article, poidsTotal, nombreCartons);
  ...
  Future<ApiResponse<Pesee>> getPesees() async {
    var response = await tracabiliteRepository.getPesee(_article);
  ...
  Future<ApiResponse> sendPesee() async {
    _response = await tracabiliteRepository.submitPesee(_pesees);
  ...
  Future<ApiResponse> deleteRemotePesee() async {
    if (_pesees.isNotEmpty) {
      var pesee = _pesees.first;
      var responseDelete = await tracabiliteRepository.deletePesees(pesee);
      return responseDelete;
    }
